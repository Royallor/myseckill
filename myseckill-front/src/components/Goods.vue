  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="goodslist" border stripe>
        ...
        <el-table-column label="库存" prop="save"></el-table-column>
        <el-table-column label="抢购开始时间" prop="begin_time" :formatter="formatDate"></el-table-column>
...
export default {
  ...
  methods: {
    async getGoodsList() {
      // 调用post请求
      const {data: res} = await this.$http.get("allGoods", {
        params: this.queryInfo
      });
      this.goodslist = res.data; // 将返回数据赋值
    ...
    formatDate(row) {
      var date=new Date(row.begin_time);
